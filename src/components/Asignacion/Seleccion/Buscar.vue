            ...
            <b-container fluid="">
                <b-row>
                    <b-col sm="12" class="mt-3">
                        <b-form-input type="text" id="campobuscarmiembro" v-model="campobuscarmiembro" autocomplete="off" @keyup.enter="buscar" placeholder="Escribe algo para buscar" size="sm"></b-form-input>
                    </b-col>
                    <b-col sm="12" class="mt-3">
...
export default {
    ...
    methods: {
        ...
        async buscar(){
            ...
            let data = {
                api: `miembros/c/f2/${this.campobuscarmiembro.toUpperCase()}`
            }
